...
# $Header: /var/cvsroot/gentoo-x86/kde-base/kdebase-meta/kdebase-meta-4.12.5.ebuild,v 1.5 2014/05/08 07:32:39 ago Exp $
...
RDEPEND="
	...
	konqueror? ( $(add_kdebase_dep konq-plugins) )
	...
	konqueror? ( $(add_kdebase_dep nsplugins) )
